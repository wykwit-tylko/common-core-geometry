use crate::primitives::{AABB, Plane, Point3D, Ray, Sphere, Triangle, Vector3D};
...
mod tests {
    ...
    fn test_ray_plane_intersection() {
        ...
        let plane = Plane::from_point_normal(&Point3D::new(0.0, 0.0, 5.0), &Vector3D::new(0.0, 0.0, 1.0)).unwrap();
